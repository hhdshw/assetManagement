...
public class R extends HashMap<String, Object> {
    ...
    public static R error(StatusEnum statusEnum, Object data) {
        return new R(statusEnum.getCode(), statusEnum.getMsg(), data);
    }
    public static R error(StatusEnum statusEnum) {
        return new R(statusEnum.getCode(), statusEnum.getMsg());
    }
    public static R success(StatusEnum statusEnum) {
        return new R(statusEnum.getCode(), statusEnum.getMsg(), null);
    }
